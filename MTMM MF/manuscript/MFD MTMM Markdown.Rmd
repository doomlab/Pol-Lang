...
####correlations ? t-tests? figure out a good way to do something here####
##here's an example of how to get correlations for stuff
apply(fair_final[ , 5:80], 2, function (x) { cor(x, fair_final$fairMFQ)})
apply(fair_final[ , 5:80], 2, function (x) { cor(x, fair_final$Q15_1)})
#apply(fair_final[ , 5:80], 2, function (x) { chisq.test(x, fair_final$Q23)})
```
...
####correlations ? t-tests? figure out a good way to do something here####
##here's an example of how to get correlations for stuff
apply(ingroup_final[ , 5:102], 2, function (x) { cor(x, ingroup_final$ingroupMFQ)})
apply(ingroup_final[ , 5:102], 2, function (x) { cor(x, ingroup_final$Q15_1)})
#apply(ingroup_final[ , 5:102], 2, function (x) { chisq.test(x, ingroup_final$Q23)})
```
...
####correlations ? t-tests? figure out a good way to do something here####
##here's an example of how to get correlations for stuff
apply(authority_final[ , 5:102], 2, function (x) { cor(x, authority_final$authorityMFQ)})
apply(authority_final[ , 5:102], 2, function (x) { cor(x, authority_final$Q15_1)})
#apply(authority_final[ , 5:102], 2, function (x) { chisq.test(x, authority_final$Q23)})
```
...
####correlations ? t-tests? figure out a good way to do something here####
##here's an example of how to get correlations for stuff
apply(purity_final[ , 5:102], 2, function (x) { cor(x, purity_final$purityMFQ)})
apply(purity_final[ , 5:102], 2, function (x) { cor(x, purity_final$Q15_1)})
#apply(purity_final[ , 5:102], 2, function (x) { chisq.test(x, purity_final$Q23)})
```
...
After consenting to participate in this study, participants were asked to write at least 1200 characters about their attitudes on abortion, same-sex marriage, or environmentalism, which were randomly assigned. Participants then completed the MFQ and demographics section. 
